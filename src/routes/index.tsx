...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Executive Dashboard — Northwind ERP" },
      {
        name: "description",
        content:
          "Cross-module ERP dashboard with approvals, receivables, inventory health and project delivery KPIs.",
      },
      { property: "og:title", content: "Executive Dashboard — Northwind ERP" },
      {
